...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "B2exYkRb6FdHHrE46D6nJv8QNS-LqVQ76oXNfKKf";
    private static final String SECRETKEY = "RedSH-O1vdON2qaJNXlIkAfADIC8iiL9NvCmDLZc";
    private static final String BUCKET = "szit106";
    public static final String DOMAIN= "http://qmm0xdou4.hn-bkt.clouddn.com/";
